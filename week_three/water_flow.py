...
# Convert pressure from kilopascals to psi (pounds per square inch)
def kilopascals_to_psi(kilopascals):
  psi = kilopascals * 0.14503773773020923
  return psi
...
def main():
    ...
    psi = kilopascals_to_psi(pressure)
    print(f"Pressure at house: {psi:.1f} kilopascals")
