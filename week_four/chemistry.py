...
known_molecules_dict = {
  ...
  "C3H6O3": "lactic acid",
  "C9H8O4": "acetylsalicylic acid (aspirin)",
  "C8H10N4O2": "caffeine",
  "C10H14N2": "nicotine",
  "C17H19NO3": "morphine",
  "C21H30O2": "progesterone",
  "C19H28O2": "testosterone",
  "C27H45OH": "cholesterol"
}
...
def sum_protons(symbol_quantity_list, periodic_table_dict):
  ...
  for i in symbol_quantity_list:
    ...
    quantity = i[QUANTITY_INDEX]
    if symbol in periodic_table_dict:
      atomic_num = periodic_table_dict[symbol][ATOMIC_NUM_INDEX]
      total_protons += atomic_num * quantity
